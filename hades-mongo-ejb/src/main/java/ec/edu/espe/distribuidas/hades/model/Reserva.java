...
public class Reserva extends BaseEntity{
    ...
    public String toString() {
        return "Reserva{" + "codigo=" + codigo + ", tour=" + tour + ", camarote=" + camarote + ", tipoAlimentacion=" + tipoAlimentacion + ", cliente=" + cliente + ", valorFinal=" + valorFinal + ", fechaEmision=" + fechaEmision + ", estado=" + estado + '}';
    }
